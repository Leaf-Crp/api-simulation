package fr.oukonmange.data.configuration;
...
@Configuration
@EntityScan("fr.oukonmange.data.entity")
@EnableJpaRepositories(basePackages= "fr.oukonmange.data.dao", entityManagerFactoryRef="entityManagerFactory")
@EnableJpaAuditing
